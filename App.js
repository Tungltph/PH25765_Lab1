...
export default function App() {
  ...
  const [addList, setAddList] = useState([
    {
      ...
      name: "a",
      desc: "a",
      link: "https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885_640.jpg",
    },
    {
      id: 1,
      name: "b",
      desc: "b",
      link: "https://cdn.pixabay.com/photo/2014/02/27/16/10/flowers-276014_960_720.jpg",
    },
    {
      id: 2,
      name: "c",
      desc: "c",
      link: "https://cdn.pixabay.com/photo/2015/12/01/20/28/road-1072823_960_720.jpg",
    },
  ]);
  ...
  const pushToList = () => {
    if (textInputValueName && textInputValueDesc && textInputValueLink) {
      ...
      var newArray = {
        id: idx,
        name: textInputValueName,
        desc: textInputValueDesc,
        link: textInputValueLink,
      };
  ...
  return (
    <View style={styles.container}>
      <Text>Họ tên: Lục Thanh Tùng</Text>
      <Text>MSV: PH25765</Text>
